...
do
    ...
    do
        for phi_update_step in 1 #5 # 10 15 20 # 2 3 4 5
        do
            for guidance_scale in 7.5 #1 2 3 4 5 8 10
            do
                for cfg_phi in 1 # 0.01 0.02 0.03 0.05
                do
                    for num_steps in 500
                    do
                        for id_loss_weight in 0.005 #0.01 0.02 0.05 0.1 # 0.01 0.02 0.03 #50 #100 300 500
                        do
                            ...
                            do
                                ...
                                python prolific_dreamer2d.py \
                                        ...
                                        --neg_prompt "a photograph of an astronaut riding a horse" \
                                        --id_loss_weight ${id_loss_weight} --cfg_phi ${cfg_phi} \
                                        --init_img_path '/cluster/home/jinliang/work/ckpts_yuazhu/prolific_dream2d/figs/final_image_a_photograph_of_an_astronaut_riding_a_horse.png' \
                                        # --half_inference true \
                                        # --t_start ${t_start}
